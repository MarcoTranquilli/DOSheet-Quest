...
export const missionLabs: MissionLabDefinition[] = [
  ...
  {
    questId: 'quest-validation-gate',
    eyebrow: 'Validation Lab',
    title: 'Bloccare input incoerenti',
    description:
      'Identifica i valori corretti per reparto e status così da preparare una validation rule semplice ma efficace.',
    columns: ['A', 'B', 'C', 'D'],
    rows: [
      ['Employee', 'Department', 'Status', 'Answer'],
      ['Marta', 'Sales', 'Allowed department', ''],
      ['Luca', 'Growth', 'Blocked department', ''],
      ['Sara', 'Ops', 'Allowed status', ''],
      ['Rules', 'Sales | Ops | Finance', 'Active | Paused', ''],
    ],
    editableCells: ['D2', 'D3', 'D4'],
    objectives: [
      {
        id: 'validation-d2',
        label: 'Conferma un reparto ammesso',
        cellId: 'D2',
        expectedValue: 'Sales',
        hintPrimary: 'Usa solo i valori presenti nell’elenco delle regole.',
        hintSecondary: 'Sales è già nella lista dei reparti ammessi, quindi può passare la validation.',
      },
      {
        id: 'validation-d3',
        label: 'Blocca il reparto non ammesso',
        cellId: 'D3',
        expectedValue: 'Blocked',
        hintPrimary: 'Growth non compare nell’elenco ammesso, quindi il valore va segnalato.',
        hintSecondary: 'Quando un valore non è nella lista, il risultato atteso qui è `Blocked`.',
      },
      {
        id: 'validation-d4',
        label: 'Conferma uno status valido',
        cellId: 'D4',
        expectedValue: 'Active',
        hintPrimary: 'Controlla la lista degli status permessi nella riga delle regole.',
        hintSecondary: 'Lo status valido da confermare è `Active`.',
      },
    ],
    victoryCopy: 'Hai ragionato come farebbe una validation rule: prima definire i valori ammessi, poi bloccare tutto il resto.',
  },
  {
    questId: 'quest-roi-analysis',
    eyebrow: 'ROI Lab',
    title: 'Leggere il ritorno di tre campagne',
    description:
      'Confronta costi e ricavi per individuare la campagna migliore e quella da rivedere prima di investire ancora.',
    columns: ['A', 'B', 'C', 'D', 'E'],
    rows: [
      ['Campaign', 'Revenue', 'Cost', 'Metric', 'Answer'],
      ['Search', '240', '120', 'Best ROI campaign', ''],
      ['Social', '180', '150', 'Weakest campaign', ''],
      ['Email', '160', '80', 'Highest profit', ''],
    ],
    editableCells: ['E2', 'E3', 'E4'],
    objectives: [
      {
        id: 'roi-e2',
        label: 'Individua la campagna con ROI migliore',
        cellId: 'E2',
        expectedValue: 'Email',
        hintPrimary: 'Confronta il ritorno rispetto al costo, non solo il ricavo assoluto.',
        hintSecondary: 'Email raddoppia il costo (160 su 80), quindi ha il ROI più forte.',
      },
      {
        id: 'roi-e3',
        label: 'Individua la campagna più debole',
        cellId: 'E3',
        expectedValue: 'Social',
        hintPrimary: 'Guarda quale iniziativa lascia meno margine rispetto all’investimento.',
        hintSecondary: 'Social ha il margine più basso: 180 - 150 = 30.',
      },
      {
        id: 'roi-e4',
        label: 'Individua il profitto più alto',
        cellId: 'E4',
        expectedValue: '120',
        hintPrimary: 'Profitto qui significa ricavo meno costo.',
        hintSecondary: 'Search genera 240 - 120 = 120 di profitto, più delle altre campagne.',
      },
    ],
    victoryCopy: 'Hai collegato ROI, profitto e decisione: è il cuore di un’analisi utile per marketing o finance.',
  },
  {
    questId: 'quest-dashboard-layout',
    eyebrow: 'Dashboard Lab',
    title: 'Dare gerarchia a un dashboard',
    description:
      'Scegli KPI principale, chart giusto e azione consigliata per ripulire un dashboard troppo denso.',
    columns: ['A', 'B', 'C', 'D'],
    rows: [
      ['Question', 'Context', 'Decision', 'Answer'],
      ['Primary KPI', 'CEO review', 'Most important metric', ''],
      ['Best chart', 'Trend over 4 months', 'Main visual', ''],
      ['Remove first', 'Dashboard too dense', 'Noise to cut', ''],
    ],
    editableCells: ['D2', 'D3', 'D4'],
    objectives: [
      {
        id: 'dashboard-d2',
        label: 'Scegli il KPI principale',
        cellId: 'D2',
        expectedValue: 'Revenue',
        hintPrimary: 'Per una review executive serve una metrica che guidi la decisione, non un dettaglio secondario.',
        hintSecondary: 'Il KPI principale atteso qui è `Revenue`.',
      },
      {
        id: 'dashboard-d3',
        label: 'Scegli il grafico corretto',
        cellId: 'D3',
        expectedValue: 'Line chart',
        hintPrimary: 'Per leggere l’andamento nel tempo la priorità è mostrare continuità tra i punti.',
        hintSecondary: 'Per un trend su più mesi la scelta giusta è `Line chart`.',
      },
      {
        id: 'dashboard-d4',
        label: 'Individua il primo elemento da rimuovere',
        cellId: 'D4',
        expectedValue: 'Duplicate chart',
        hintPrimary: 'Quando il dashboard è troppo carico, taglia prima gli elementi che ripetono la stessa informazione.',
        hintSecondary: 'L’elemento da rimuovere per primo qui è `Duplicate chart`.',
      },
    ],
    victoryCopy: 'Hai dato una gerarchia al dashboard: meno rumore, più decisione e meno tempo perso in lettura.',
  },
  {
    questId: 'quest-script-automation',
    eyebrow: 'Script Logic Lab',
    title: 'Tradurre un task in logica di script',
    description:
      'Definisci trigger, action e output finale di uno script semplice prima ancora di scrivere codice.',
    columns: ['A', 'B', 'C', 'D'],
    rows: [
      ['Step', 'Scenario', 'Target', 'Answer'],
      ['Trigger', 'New lead arrives in sheet', 'Start event', ''],
      ['Action', 'Assign owner and timestamp', 'Main step', ''],
      ['Output', 'Notify sales team', 'Final result', ''],
    ],
    editableCells: ['D2', 'D3', 'D4'],
    objectives: [
      {
        id: 'script-d2',
        label: 'Definisci il trigger iniziale',
        cellId: 'D2',
        expectedValue: 'New row added',
        hintPrimary: 'Il trigger descrive l’evento che fa partire il flusso in automatico.',
        hintSecondary: 'Per questo scenario il trigger atteso è `New row added`.',
      },
      {
        id: 'script-d3',
        label: 'Definisci l azione principale',
        cellId: 'D3',
        expectedValue: 'Assign owner',
        hintPrimary: 'L’azione principale è il cuore del workflow, non la notifica finale.',
        hintSecondary: 'Qui l’azione centrale attesa è `Assign owner`.',
      },
      {
        id: 'script-d4',
        label: 'Definisci l output finale',
        cellId: 'D4',
        expectedValue: 'Sales notified',
        hintPrimary: 'L’output è il risultato osservabile dopo che il flusso ha lavorato.',
        hintSecondary: 'In questo caso l’output finale atteso è `Sales notified`.',
      },
    ],
    victoryCopy: 'Hai trasformato un task ripetitivo in logica operativa chiara: è esattamente il passaggio che precede uno script utile.',
  },
];
